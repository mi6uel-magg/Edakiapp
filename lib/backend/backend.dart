...
import 'schema/archivo_record.dart';
...
export 'schema/archivo_record.dart';
...
/// Functions to query ArchivoRecords (as a Stream and as a Future).
Stream<List<ArchivoRecord>> queryArchivoRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      ArchivoRecord.collection(parent),
...
Future<List<ArchivoRecord>> queryArchivoRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<FFFirestorePage<ArchivoRecord>> queryArchivoRecordPage({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
